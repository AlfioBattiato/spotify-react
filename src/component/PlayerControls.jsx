        ...
        <Col lg={10} className="offset-lg-2 h-100">
          <Row className="h-100 ">
            ...
            <Col xs={3} md={2} className=''>
              {selector && (<img className="img-fluid" src={selector.album.cover_medium} alt="track" style={{ height: "5rem" }} />
              )}

            </Col>
            <Col xs={3} md={2} className=''>
              {!like ? (<svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="white" class="bi bi-suit-heart" viewBox="0 0 16 16">
              ...
              </svg>) : (<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="white" class="bi bi-suit-heart-fill" viewBox="0 0 16 16">
            ...
            <Col xs={1} md={2} className=''>
              {selector && (<>
                ...
                <p className='text-white'>{selector.title.substring(0, 16)}...</p>
